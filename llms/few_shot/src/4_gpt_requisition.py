...
if __name__ == '__main__':
    ...
    inputs = pf.read_input_file(r"llms\few_shot\data\inputs.txt")
    inputs = pf.pre_process_input_file(inputs)

    prompts_one_five_ex = pf.read_input_file(r"llms\few_shot\data\prompt_five_ex.txt")
    prompts_one_five_ex = pf.pre_process_input_file(prompts_one_five_ex)

    results_one_five_ex = gpt_req(inputs, prompts_one_five_ex)
    pf.write_output_file(r"llms\few_shot\data\gpt\results_prompt_five_ex.txt", results_one_five_ex)
