...
if __name__ == '__main__':
    #Zero Shot
    input_filename = "llms/zero_shot/data/deep_seek/results_prompt_structured.csv"
    output_filename = "llms/zero_shot/data/deep_seek/results_prompt_structured_post_processed.csv"

    #input_filename = "llms/few_shot/data/llama/results_prompt_five_ex_structured.csv"
    #output_filename = "llms/few_shot/data/llama/results_prompt_five_ex_structured_post_processed.csv"
