...
if __name__ == '__main__':
    ...
    # Zero Shot
    #input_filename = "llms/zero_shot/data/llama/results_prompt.jsonl"
    #output_filename = "llms/zero_shot/data/llama/results_prompt_structured.csv"

    # Few Shot
    input_filename = "llms/few_shot/data/llama/results_prompt.jsonl"
    output_filename = "llms/few_shot/data/llama/results_prompt_five_ex_structured.csv"
