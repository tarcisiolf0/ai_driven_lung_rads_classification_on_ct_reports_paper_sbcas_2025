...
if __name__=='__main__':
    ...
    columns = [
    ("O nódulo tem atenuação sólida ou em partes moles?", "O nódulo tem atenuação sólida ou em partes moles?"),
    ("O nódulo tem atenuação em vidro fosco?", "O nódulo tem atenuação em vidro fosco?"),
    ("O nódulo tem borda espiculada ou irregular ou mal definida?", "O nódulo tem borda espiculada ou irregular ou mal definida?"),
    ("O nódulo é calcificado?", "O nódulo é calcificado?"),
    ("Localização do nódulo", "Localização do nódulo"),
    ("Tamanho do nódulo (mm)", "Tamanho do nódulo (mm)")
]
    df_test = pd.read_csv("doc_similarity/data/test_post_processed.csv")

    # Zero shot
    df_result = pd.read_csv("llms/zero_shot/data/deep_seek/results_prompt_structured_post_processed.csv")
    csv_filename = "llms/zero_shot/data/deep_seek/metrics_prompt_structured.csv"

    # Few shot
    #df_result = pd.read_csv("llms/few_shot/data/llama/results_prompt_five_ex_structured_post_processed.csv")
    #csv_filename = "llms/few_shot/data/llama/metrics_results_prompt_five_ex_structured_post_processed.csv"
